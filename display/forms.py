...
class ExperimentSettingForm(FlaskForm):
    ...
    thermomixer_time_s = IntegerField('Thermomixer Time (s)', validators=[DataRequired(), NumberRange(min=1)])
    liquid_nitrogen_time_s = IntegerField('Liquid Nitrogen Time (s)', validators=[DataRequired(), NumberRange(min=1)])
